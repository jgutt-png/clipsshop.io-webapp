    ...
    <div className="bg-white">
      ...
      <main>
        ...
        <div className="relative isolate overflow-hidden bg-gray-900 pb-16 pt-14 sm:pb-20">
          <img
            src="https://reup-main-website.s3.us-east-2.amazonaws.com/BlueFadeBGHomes.gif"
            alt=""
          ...
          <div className="absolute inset-x-0 -top-40 -z-10 transform-gpu overflow-hidden blur-3xl sm:-top-80" aria-hidden="true">
            <div 
              className="relative left-[calc(50%-11rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 rotate-[30deg] bg-gradient-to-tr from-[#017ca2] to-[#017ca2]/60 opacity-30 sm:left-[calc(50%-30rem)] sm:w-[72.1875rem]" 
              style={{ 
